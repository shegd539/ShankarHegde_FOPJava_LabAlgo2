...
/**
 * Problem Statement-2 you are a traveler and traveling to a country where the
 * currency denominations are unknown and as you travel you get to know about
 * the denomination in random order. You want to make a payment of amount x, in
 * such a way that the higher denomination is used to make exact payment
 * 
 * @author shankar
 *
 */
public class NotesCounterDriver {
	...
	public static void main(String[] args) {
		...
		int numberOfDenominations = userInput.nextInt();
		...
		for (int i = 0; i < numberOfDenominations; i++) {
			arrDenominations[i] = userInput.nextInt();
		}
		...
		int amountToPay = userInput.nextInt();
